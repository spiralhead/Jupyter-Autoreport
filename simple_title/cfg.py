...
c = get_config()
c.TemplateExporter.extra_template_paths = [os.path.dirname(os.path.realpath(__file__)), os.path.expanduser('~/.jupyter/templates/')]
c.TagRemovePreprocessor.enabled=True
c.TagRemovePreprocessor.remove_cell_tags=("Skip",)
c.Exporter.template_file = 'article.tplx'
...
#------------------------------------------------------------------------------
## Установка контроль-доступа-разрешенные-учетные_данные: заголовок true
#  Default: False
...
## Следует ли разрешить пользователю запускать блокнот от имени root.
#  Default: False
...
## Класс менеджера конфигурации для использования
#  Default: 'notebook.services.config.manager.ConfigManager'
# c.NotebookApp.config_manager_class = 'notebook.services.config.manager.ConfigManager'

## Используемый класс менеджера блокнотов.
...
## Файл, в котором хранится пароль cookie.
#  Default: ''
...
## URL-адрес по умолчанию для перенаправления на `/`
#  Default: '/tree'
...
## дополнительные пути для поиска расширений блокнота Javascript
#  Default: []
...
#  
#          Может использоваться для переопределения шаблонов из
#  notebook.templates.
#  Default: []
...
## Устарело: используйте уменьшенный файл JS или нет, в основном используется во
#  время разработки чтобы избежать перекомпиляции JS
#  Default: False
...
## IP-адрес, который будет прослушиваться сервером блокнота.
#  Default: 'localhost'
# c.NotebookApp.ip = 'localhost'

## Предоставьте дополнительные аргументы, передаваемые в среду Jinja.
#  Default: {}
...
## Используемый класс менеджера ядра.
...
## Полный путь к файлу приватного ключа для использования с SSL/TLS.
#  Default: ''
...
## Используемый класс обработчика входа в систему.
#  Default: 'notebook.auth.login.LoginHandler'
# c.NotebookApp.login_handler_class = 'notebook.auth.login.LoginHandler'

## Используемый класс обработчика выхода из системы.
#  Default: 'notebook.auth.logout.LogoutHandler'
# c.NotebookApp.logout_handler_class = 'notebook.auth.logout.LogoutHandler'

## Использовать файл конфигурации MathJax.js.
...
## Каталог, используемый для блокнотов и ядер.
#  Default: ''
...
## УСТАРЕЛО - используйте nbserver_extensions вместо диктата
#  Default: []
# c.NotebookApp.server_extensions = []

## Класс менеджера сеансов для использования.
...
## УСТАРЕЛО - используйте tornado_settings
#  Default: {}
...
#  
#  Это значение будет возвращено из :meth:
#  'WebSocketHandler.get_compression_options`. None (по умолчанию) отключит
#  сжатие. Диктат (даже пустой) будет включать сжатие.
#  
#  Смотрите документы tornado для WebSocketHandler.get_compression_options для
...
# c.ContentsManager.untitled_notebook = 'Без названия'
...
# c.FileContentsManager.untitled_notebook = 'Без названия'
...
#  Choices: any of ['sha512', 'sha384', 'sha256', 'sha3_512', 'sha224', 'blake2b', 'sha3_256', 'md5', 'sha3_384', 'sha3_224', 'sha1', 'blake2s']
#  Default: 'sha256'
